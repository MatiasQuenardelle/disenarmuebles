    ...
    <section className="px-6 py-24">
      <div className="mx-auto max-w-2xl">
        ...
        <p className="mb-12 text-center text-text-muted">
          La forma más rápida de contactarnos es por WhatsApp. Te respondemos
          al instante.
        </p>
        ...
        <div className="space-y-8">
          ...
          <div className="rounded-2xl border border-brand-light/30 bg-cream-dark p-8 text-center">
            ...
            <h2 className="mb-2 text-xl font-bold text-warm-brown">
              WhatsApp
            </h2>
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            ...
            <div className="rounded-2xl border border-brand-light/30 bg-cream-dark p-6">
              ...
              <p className="text-sm text-text-muted">{siteInfo.hours}</p>
            </div>
          </div>

          {/* Payment methods */}
          <div className="rounded-2xl border border-brand-light/30 bg-cream-dark p-6">
            <h3 className="mb-4 font-semibold text-warm-brown">
              Medios de Pago
            </h3>
            <ul className="grid gap-2 sm:grid-cols-2">
              {siteInfo.paymentMethods.map((method) => (
                <li key={method} className="flex items-center gap-2 text-sm text-text-muted">
