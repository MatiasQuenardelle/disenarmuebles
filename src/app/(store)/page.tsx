  ...
  return (
    <>
      ...
      <section className="px-6 py-16">
        <div className="mx-auto max-w-5xl rounded-3xl border border-brand-light/20 bg-cream-dark p-8 sm:p-10">
          <div className="text-center">
            <p className="mb-3 text-sm font-medium uppercase tracking-[0.25em] text-brand">
              Formas de Pago
            </p>
            <h3 className="mb-8 font-heading text-2xl font-semibold text-warm-brown sm:text-3xl">
              Financiá tu compra en cuotas
            </h3>
          </div>
          <div className="grid gap-6 sm:grid-cols-3">
            <div className="text-center">
              ...
              <h4 className="mb-1 font-semibold text-warm-brown">Hasta 12 cuotas</h4>
              <p className="text-sm text-text-muted">Tarjeta Naranja y Cordobesa</p>
            </div>
            <div className="text-center">
              <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-2xl bg-brand/10">
                <svg className="h-6 w-6 text-brand" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              <h4 className="mb-1 font-semibold text-warm-brown">Hasta 6 cuotas</h4>
              <p className="text-sm text-text-muted">Visa y Mastercard bancarizadas</p>
            </div>
            <div className="text-center">
              <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-2xl bg-[#25D366]/10">
                <svg className="h-6 w-6 text-[#25D366]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 013 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 00-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 01-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 003 15h-.75M15 10.5a3 3 0 11-6 0 3 3 0 016 0zm3 0h.008v.008H18V10.5zm-12 0h.008v.008H6V10.5z" />
                </svg>
              </div>
              <h4 className="mb-1 font-semibold text-warm-brown">Precio especial</h4>
              <p className="text-sm text-text-muted">Efectivo o transferencia bancaria</p>
            </div>
          </div>
        </div>
      </section>
