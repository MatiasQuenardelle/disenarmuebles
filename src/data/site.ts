...
export const siteInfo: SiteInfo = {
  ...
  paymentMethods: [
    "Tarjeta Naranja y Cordobesa: hasta 12 cuotas",
    "Visa y Mastercard bancarizadas: hasta 6 cuotas",
    "Transferencia bancaria (precio con descuento)",
    "Efectivo (precio con descuento)",
    "Mercado Pago",
  ],
  socialMedia: {
