...
export const products: Product[] = [
  ...
  },
  {
    ...
    images: [
      ...
      { src: "/products/mesa-de-luz-clasica/clasica.jpeg", alt: "Mesa de Luz Clásica producto" },
  ...
  },
  {
    ...
    images: [
      { src: "/products/colchon-canon-tropical/showcase.jpeg", alt: "Colchón Canon Tropical vista completa" },
      { src: "/products/colchon-canon-tropical/info.jpeg", alt: "Colchón Canon Tropical especificaciones" },
    ],
    sizes: ["1 Plaza (080x190)", "1½ Plaza (100x190)", "2 Plazas (140x190)", "Queen (160x200)", "King (180x200)"],
